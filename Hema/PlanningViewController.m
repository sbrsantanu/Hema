...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        self=((([[UIScreen mainScreen] bounds].size.height)>500))?[super initWithNibName:@"PlanningViewController" bundle:nil]:[super initWithNibName:@"PlanningViewController4s" bundle:nil];
    }
    return self;
}
