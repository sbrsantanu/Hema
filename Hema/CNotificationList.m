...
@interface CNotificationList ()<UIScrollViewDelegate,UITableViewDataSource,UITableViewDelegate>
{
    CGRect mainFrame;
}
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    NSArray *dataTitleArray = [[NSArray alloc] initWithObjects:@"Event Title",@"Event Status",@"Notifications",@"View", nil];
