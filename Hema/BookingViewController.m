...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        self=((([[UIScreen mainScreen] bounds].size.height)>500))?[super initWithNibName:@"BookingViewController" bundle:nil]:[super initWithNibName:@"BookingViewController4s" bundle:nil];
    }
    return self;
}
