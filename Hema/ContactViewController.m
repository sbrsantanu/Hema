...
- (void)viewDidLoad {
    ...
    self.DataValueArray = [[NSArray alloc] initWithObjects:@"7", nil];
...
-(void)CallWebserviceForData
{
    if (!IS_NETWORK_AVAILABLE())
    {
        ...
        NSURL *ParamObjectURL = [[NSURL alloc] initWithString:@"http://myphpdevelopers.com/dev/hema/app/webroot/hema/pages.php?page_id=7"];
