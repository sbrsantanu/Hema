...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        self=((([[UIScreen mainScreen] bounds].size.height)>500))?[super initWithNibName:@"ContactViewController" bundle:nil]:[super initWithNibName:@"ContactViewController4s" bundle:nil];
    }
    return self;
}
